    ...
    return (
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 shrink-0">
            <div className="flex items-center gap-4">
                <div className="relative">
                    ...
                    <div className="relative p-3 rounded-2xl bg-white/80 dark:bg-white/10 backdrop-blur-xl border border-white/20 dark:border-white/10 shadow-xl shadow-violet-500/10">
                        <HugeiconsIcon icon={Layout01Icon} className="h-8 w-8 text-violet-600 dark:text-violet-400" />
                    </div>
                </div>
                <div>
                    ...
                    <p className="text-slate-500 dark:text-violet-200/70 text-sm font-medium">
            ...
            <div className="flex items-center gap-3">
                ...
                >
                    <HugeiconsIcon icon={Refresh01Icon} className="h-4 w-4 text-violet-600 dark:text-violet-400" />
                </Button>
                <Button 
                    onClick={onNewWorkflow} 
                    className="h-11 px-6 rounded-xl bg-linear-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white font-black text-xs uppercase tracking-widest shadow-lg shadow-violet-500/25 hover:shadow-violet-500/40 hover:scale-[1.02] transition-all duration-300"
                >
