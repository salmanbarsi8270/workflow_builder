                    ...
                    <SelectValue>
                        {isLocalLoading ? (
                            ...
                            <div className="flex items-center gap-2 overflow-hidden w-full">
                                ...
                                <span className="text-xs font-medium truncate flex-1 text-left">{selectedConnection.name}</span>
                            </div>
                        ) : (
                        ...
                        <div key={conn.id} className="group relative flex items-center pr-8 hover:bg-muted/50 rounded-sm">
                            <SelectItem value={conn.id} className="flex-1 cursor-pointer focus:bg-transparent">
                                <div className="flex flex-col py-0.5">
                                    ...
                                    <span className="text-[9px] text-muted-foreground">ID: {conn.id.slice(0, 8)}</span>
                                </div>
                            </SelectItem>
                            <button
