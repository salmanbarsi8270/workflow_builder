...
import { Zap, Sparkles, X, Loader2, UserCircle, RefreshCw } from "lucide-react";
...
export function ConnectionListCard({ account, onDelete, isDeleting, onEditConnection, onSyncCatalog }: ConnectionListCardProps) {
  return (
    <motion.div
      layout
