              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    type="submit"
                    size="icon"
                    disabled={!inputValue.trim() || isLoading || !currentConversationId}
                    className={cn(
                      "h-9 w-9 rounded-full transition-all shadow-sm",
                      inputValue.trim() && currentConversationId
                ...
                <TooltipContent>
                  {currentConversationId ? "Send message" : "Select a project first"}
                </TooltipContent>
              </Tooltip>
            </div>
          </form>
